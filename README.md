...
| **[Higgsfield](#2-higgsfield)** | First-party hosted MCP connector, plus an official CLI | No | [check](https://higgsfield.ai/pricing) | 40+ models per the official CLI README | [pricing](https://higgsfield.ai/pricing) | [higgsfield-ai/cli](https://github.com/higgsfield-ai/cli) — 499 ★, v1.1.24 |
...
| **[Replicate](#5-replicate)** | Community MCP servers only — no first-party server | Yes | [check](https://replicate.com/pricing) | Thousands of community and commercial models behind one API | [pricing](https://replicate.com/pricing) | [replicate/replicate-python](https://github.com/replicate/replicate-python) — 914 ★, 1.0.7 |
